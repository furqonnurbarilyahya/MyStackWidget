package com.bangkit.mystackwidget
...
class ImageBannerWidget : AppWidgetProvider() {
    ...
    companion object {
        ...
        private fun updateAppWidget(
            ...
            views.setRemoteAdapter(R.id.stacksView, intent)
            views.setEmptyView(R.id.stacksView, R.id.empty_view)
            ...
            views.setPendingIntentTemplate(R.id.stacksView, toastPendingIntent)
